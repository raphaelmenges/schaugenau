...
public class Lily extends Flower {
	...
	/* constructor */
	public Lily(App app, int score, float butterflyX, float butterflyY, LinkedList<StaticEntity> terrainList,
			boolean debugging) {
		super(app, "Lily", butterflyX, butterflyY, terrainList, debugging);
		this.score = score;
		this.focusColor = new ColorRGBA(1.0f, 0.0f, 0.75f, 0.5f);
	}
	...
	public MortalEmitter getPickEmitter(Application app) {
		...
		emitterMat.setTexture("Texture", app.getAssetManager().loadTexture("Textures/LilyParticles.png"));
